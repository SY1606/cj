...
import com.example.yuekao6.adapter.GoodsListAdapter;
import com.example.yuekao6.animator.ScaleItemAnimator;
import com.example.yuekao6.bean.Goods;
import com.example.yuekao6.bean.Result;
import com.example.yuekao6.core.DataCall;
import com.example.yuekao6.presenter.GoodsListPresenter;
import com.example.yuekao6.util.recyclerview.SpacingItemDecoration;
...
//        StaggeredGridLayoutManager layoutManager = new StaggeredGridLayoutManager(2,StaggeredGridLayoutManager.VERTICAL);
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.btn_search) {//搜索
            ...
            mAdapter.notifyDataSetChanged();
        }else if (v.getId() == R.id.shop_car){  //点击购物车图片跳转到页面
