...
import com.example.yuekao8.adapter.CartAdapter;
...
public class ShopCartActivity extends AppCompatActivity implements DataCall<List<Shop>>,CartAdapter.TotalPriceListener {
